// this is src/debayerpipeline.cpp
#include "../include/debayerpipeline.h"
 // 包含 CUDA 核函数声明

#define DBG_DEBAYER

DebayerPipeline::DebayerPipeline(Tensor&& input_tensor_cpu, int width, int height)
...
DebayerPipeline::~DebayerPipeline() {
#ifdef DBG_DEBAYER
    printf("~DebayerPipeline()\n");
#endif
}

Tensor DebayerPipeline::process() {
    // 执行 CUDA 核函数
